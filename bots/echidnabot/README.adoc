...
NOTE: Echidnabot exists in two trees by design — this **fleet copy** (deployed production bot) and the **standalone** repo at `hyperpolymath/echidnabot` (SDK / library / reference implementation). See link:CANONICAL_SOURCE.md[CANONICAL_SOURCE.md] for the file-class canonical map and contributor decision tree.
...
Contributions welcome! Please see link:../../.github/CONTRIBUTING.md[../../.github/CONTRIBUTING.md] for guidelines.
