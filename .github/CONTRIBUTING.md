...
git clone <https://github.com/hyperpolymath/gitbot-fleet.git> cd
gitbot-fleet
...
toolbox create gitbot-fleet-dev toolbox enter gitbot-fleet-dev \#
...
manifest (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/gitbot-fleet/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/gitbot-fleet/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/gitbot-fleet/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/gitbot-fleet/labels/perimeter-3) — Community sandbox scope
