...
|`+process-findings+` |Process `+findings/<repo>/latest.json+`, dispatch
...
`+sustainabot analyze <file>+`, `+sustainabot self-analyze+`
(dogfooding) - CLI: `+sustainabot check <dir>+` (recursive directory
...
*CLI*: `+sustainabot analyze <file>+` / `+sustainabot check <dir>+` /
